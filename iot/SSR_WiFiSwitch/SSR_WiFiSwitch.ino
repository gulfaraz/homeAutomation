...
//***** Settings declare ********************************************************************************************************* 
String hostName ="gulfaraz-IOT"; //The MQTT ID -> MAC adress will be added to make it kind of unique
String passwordString ="7829782782";
...
char* password; //The DNS password
...
void setup() {
  ...
  password = (char*) passwordString.c_str();
  loadConfig();
  //loadConfigOld();
